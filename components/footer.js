    ...
    <footer className='main-footer'>
          ...
          <div className='footer-content-inner d-flex align-items-start justify-content-between'>
            <div className='footer-left'>
              ...
              <div className='footer-left-text'>
                Simple — самый быстрорастущий магазин приложений и платформа распространения в мире. Мы глобальная платформа для глобальных
                талантов. Присоединяйтесь к нам.
              </div>
            </div>
                ...
                <div className='footer-item-row d-flex align-items-center'>
                  <a className='social-item d-flex align-items-center justify-content-center' href='#'>
                    <svg xmlns='http://www.w3.org/2000/svg' width='6' height='10' fill='none'>
                      <g clipPath='url(#a)'>
                        <path
                          fill='#BDBDBD'
                          d='m5.067 5.7.282-1.835H3.614v-1.17a.915.915 0 0 1 1.032-.99h.798V.143A9.58 9.58 0 0 0 4.026.017c-1.45 0-2.395.868-2.395 2.469v1.38H.021V5.7h1.61v4.303h1.983V5.701h1.453Z'
                        />
                      </g>
                      <defs>
                        <clipPath id='a'>
                  ...
                  <a className='social-item d-flex align-items-center justify-content-center' href='#'>
                    <svg xmlns='http://www.w3.org/2000/svg' width='10' height='10' fill='none'>
                      <path
                        fill='#BDBDBD'
                        d='M7.645 1.784a.583.583 0 1 0 0 1.166.583.583 0 0 0 0-1.166ZM5.038 2.536a2.466 2.466 0 1 0-.012 4.933 2.466 2.466 0 0 0 .012-4.933Zm0 4.041a1.58 1.58 0 1 1 0-3.16 1.58 1.58 0 0 1 0 3.16Z'
                      />
                      <path
                        fill='#BDBDBD'
                        d='M6.997 10H3.01A3.009 3.009 0 0 1 0 6.997V3.003A3.009 3.009 0 0 1 3.003 0h3.994A3.009 3.009 0 0 1 10 3.003v3.994A3.009 3.009 0 0 1 6.997 10ZM3.01.945A2.064 2.064 0 0 0 .945 3.003v3.994a2.064 2.064 0 0 0 2.064 2.058h3.988a2.064 2.064 0 0 0 2.064-2.058V3.003A2.064 2.064 0 0 0 6.997.945H3.01Z'
                      />
                    </svg>
                  </a>
                  <a className='social-item d-flex align-items-center justify-content-center' href='#'>
                  ...
                  <a className='social-item d-flex align-items-center justify-content-center' href='#'>
                    <svg xmlns='http://www.w3.org/2000/svg' width='11' height='13' fill='none'>
                      <path
                        fill='#BDBDBD'
                        d='M.178 4.62h2.294v7.376H.178V4.62ZM1.33.956a1.33 1.33 0 1 1 0 2.659 1.33 1.33 0 0 1 0-2.66ZM3.89 4.62h2.198v1.005A2.432 2.432 0 0 1 8.252 4.44c2.326 0 2.748 1.524 2.748 3.51v4.053H8.714v-3.59c0-.811 0-1.954-1.192-1.954-1.191 0-1.378.932-1.378 1.897v3.647H3.858l.033-7.384Z'
                      />
                    </svg>
                  </a>
                  <a className='social-item d-flex align-items-center justify-content-center' href='#'>
                    <svg xmlns='http://www.w3.org/2000/svg' width='9' height='11' fill='none'>
                      <path
                        fill='#BDBDBD'
                        d='M9 4.445h-.259c-.466 0-.925-.121-1.336-.353a2.857 2.857 0 0 1-1.014-.977v4.53a3.456 3.456 0 0 1-.532 1.859c-.35.551-.847.982-1.43 1.237a3.064 3.064 0 0 1-1.846.197 3.153 3.153 0 0 1-1.639-.909 3.394 3.394 0 0 1-.88-1.709 3.489 3.489 0 0 1 .175-1.932A3.317 3.317 0 0 1 1.41 4.882a3.096 3.096 0 0 1 1.773-.57h.195V5.96h-.195a1.566 1.566 0 0 0-.654.1c-.209.079-.4.202-.562.362a1.71 1.71 0 0 0-.38.566 1.776 1.776 0 0 0 0 1.354c.089.214.218.407.38.566.162.16.353.283.562.363.21.08.432.113.654.1a1.6 1.6 0 0 0 .642-.11c.205-.08.393-.202.554-.359.16-.156.289-.344.38-.553.09-.208.14-.434.148-.663V0h1.506c.067.686.363 1.325.836 1.804.473.48 1.093.77 1.75.818v1.835'
                      />
                    </svg>
                  </a>
                </div>
            ...
            <div className='footer-right'>
              ...
              <div className='footer-menu'>
                <ul className='list-none p-0 m-0'>
                  <li>
                    <Link className='text-decoration-none' href='/reviews/all'>
                      Отзывы
                    </Link>
                  </li>
                  <li>
      ...
      <div className='under-footer'>
        <div className='container d-flex align-items-center justify-content-between'>
          <div className='copyright'>©{new Date().getFullYear()} Simple. Все права защищены</div>
          <Link className='under-footer-link' href='/'>
            Политика конфидециальности
          </Link>
          <a
            href='https://is-art.ru/'
            target='_blank'
            className='under-footer-link isart-link d-flex align-items-center text-decoration-none'>
            Разработано
