                ...
                <div className="container">
                    ...
                    <div className="invite-wrapper d-grid">
                        <div className="invite-content">
                            ...
                            <div className="invite-share">
                                ...
                                <div className="invite-share_row d-flex align-items-center justify-content-between">
                                    <div className="invite-share_link">htps:\\simple.ru\hgdhsgdgd21049</div>
                                    <BtnCopy />
                                </div>
                        ...
                        <div className="sell-start_banner gradient_green w-100 position-relative">
                            <div className="sell-start_banner-text w-100 mx-auto text-center">Вы также можете зарабатывать приглашая своих друзей на наш сайт</div>
                        ...
                        <div className="invite-triggers-content d-grid">
                            <div className="invite-triggers-item d-flex align-items-start justify-content-between">
                                ...
                                <div className="invite-triggers-item-info">
                                    ...
                                    <div className="invite-triggers-item-text">Награда зачисляется рублями на ваш баланс на сайте. Вы можете потратить средства на покупки, вывести нельзя</div>
                                </div>
                            </div>
                            <div className="invite-triggers-item d-flex align-items-start justify-content-between">
                                <div className="invite-triggers-item-icon d-flex align-items-center justify-content-center">
                                ...
                                <div className="invite-triggers-item-info">
                                    ...
                                    <div className="invite-triggers-item-text">Например, пользователь зарегистрировался по вашей ссылке и сделал покупку на 1000 ₽. Вы получите 100 ₽. Если он совершит еще одну покупку, вы не получите бонус</div>
                                </div>
                            </div>
                            <div className="invite-triggers-item d-flex align-items-start justify-content-between">
                                <div className="invite-triggers-item-icon d-flex align-items-center justify-content-center">
                                ...
                                <div className="invite-triggers-item-info">
                                    ...
                                    <div className="invite-triggers-item-text">Награда приходит за тех, кто регистрируется на Playerok по вашей ссылке. Уже зарегистрированные пользователи засчитаны не будут</div>
                                </div>
                            </div>
                            <div className="invite-triggers-item d-flex align-items-start justify-content-between">
                                <div className="invite-triggers-item-icon d-flex align-items-center justify-content-center">
                                ...
                                <div className="invite-triggers-item-info">
                                    ...
                                    <div className="invite-triggers-item-text">Нельзя создать вторые аккаунты. Ваш профиль будет заблокирован, а средства заморожены</div>
                                </div>
                            </div>
                        </div>
                    </div>
